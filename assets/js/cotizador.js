document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateSummary() {
        ...
        let priceText = state.category === 'prendas' ? 'Por confirmar' : `Q ${state.estimatedTotal.toFixed(2)}`;
        
        html += `
            <div class="summary-total">
                <span>Costo Estimado*</span>
                <h3>${priceText}</h3>
                <p class="disclaimer">*Precio referencial. Las prendas quedan sujetas a confirmación.</p>
            </div>
        `;
